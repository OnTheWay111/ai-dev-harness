...
- [ ] **P1-04** 增加临时测试数据库集成测试，覆盖迁移、写投影、筛选、分页和空投影错误。
...
- [ ] **P2-04** 实现领域状态机、乐观版本号、唯一约束和显式状态转换。
...
- [ ] **P3-05** 增加越权、跨项目数量泄漏、重复提交和审计完整性测试。
...
- [ ] **P4-04** 保存问答历史、人工决定、版本和重新生成关系，不覆盖旧版本。
...
- [ ] **P4-05** 实现确定性的 S/M/L/XL、风险等级和所需审批层级分类。
